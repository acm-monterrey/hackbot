...
module.exports = {
    name: 'mentorlist',
    description: 'Show mentor list.',
    aliases: ['ml'],
    async execute (client, message, cmd, args, Discord) {
        if(message.channel.id === '810379900418129950') {
            ...
            for(let mentor of list[page]) {
                embed.addField(
                    `―――――――――――――――――――`, `${mentor.username} | ${mentor.skills} | ${mentor.status ? '🟩' : '🟥'}`, false
                )
                counter++;
            }
            ...
            message.channel.send("```Canal incorrecto para mentoria.```")
        }
    },
